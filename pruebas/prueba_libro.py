...
class TestLibro(unittest.TestCase):
    ...
    def test_ejemplares_invalido(self):
        with self.assertRaises(ValueError):
            Libro("9783161484102", "Libro sin ejemplares", "Autor Z", -1, "Editorial Test", "Historia", "3ºESO")
    ...
    def test_str(self):
        ...
        esperado = ("ISBN: 9783161484104 Título: Ciencias Naturales Autor: Autor N "
                    "Ejemplares: 8 Editorial: Editorial GHI Materia: Ciencias Curso: 2ºESO")
